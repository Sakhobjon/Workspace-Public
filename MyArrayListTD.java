 ...
 *
 */
public class MyArrayListTD<T> implements List<T> {
    ...
    public MyArrayListTD() {
        ...
        array = (T[]) new Object[10];// 10 개 요소를 갖는 배열 생선
        size = 0;
    }
    ...
    public static void main(String[] args) {
        ...
        MyArrayListTD<Integer> mal = new MyArrayListTD<Integer>();
        mal.add(1);
        mal.add(2);
        mal.add(3);
